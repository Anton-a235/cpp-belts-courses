...
{
    static constexpr size_t count = static_cast<size_t>(TAirport::Last_);
...
public:
    ...
    {
        return items_[static_cast<size_t>(airport)];
    }

    // добавить данный элемент
    void Insert(TAirport airport)
    {
        ++items_[static_cast<size_t>(airport)];
    }
    ...
    {
        items_[static_cast<size_t>(airport)] = 0;
    }
    ...
    Items GetItems() const
    {
        ...
        {
            result[a] = {static_cast<TAirport>(a), items_[a]};
        }
